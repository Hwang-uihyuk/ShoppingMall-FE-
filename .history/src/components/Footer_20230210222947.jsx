  ...
  return (
    ...
    <div class="">
        ...
        border-1-0 shadow-xl"
         ></div>
    <footer className="py-3 my-4 bg-slate-100">
        ...
        <div className='flex flex-row-reverse'> 본 사이트는 비상업적인 용도로 운영되고 있습니다. </div>
        <div className="flex flex-row-reverse">출저 : www.musinsa.com</div>
