...
const handleSubmit = (e) => {
  e.preventDefault();
  console.log("button을 눌러도 submit됨")
  const data = JSON.stringify({
    ...
    "size" : size,
    "imgKey" : "https://mallimageupload.s3.ap-northeast-2.amazonaws.com/upload/outer6.jpg",
    "data" : now
  })
  axios.put("http://3.38.35.43:8080/register/product",data,{
    headers: {
