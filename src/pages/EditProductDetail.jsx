...
const EditSizeBtn = (e) => {
  ...
  return (              
    <section className="bg-white justify-items-center justify-center px-6 py-8 md:h-full lg:py-0 max-h-full">
        ...
        <a href="#" className="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
            ...
            Shoppy      </a>
      <div className="w-full bg-white rounded-lg shadow dark:border md:m-full sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
